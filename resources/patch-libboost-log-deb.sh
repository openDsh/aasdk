...
dpkg-deb -b /tmp/armhf/libboost-log-dev/ libboost-log-dev_1.67.0.1_armhf.deb
...
dpkg-deb -b /tmp/amd64/libboost-log-dev/ libboost-log-dev_1.67.0.1_amd64.deb
...
dpkg-deb -b /tmp/armhf/libboost-log1.67-dev/ libboost-log1.67-dev_1.67.0-13+deb10u1_armhf.deb
...
dpkg-deb -b /tmp/amd64/libboost-log1.67-dev/ libboost-log1.67-dev_1.67.0-13+deb10u1_amd64.deb
...
dpkg-deb -b /tmp/armhf/libboost-log1.67.0/ libboost-log1.67.0_1.67.0-13+deb10u1_armhf.deb
...
dpkg-deb -b /tmp/amd64/libboost-log1.67.0/ libboost-log1.67.0_1.67.0-13+deb10u1_amd64.deb